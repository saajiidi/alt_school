    ...
    <section className="home">
      <div className="hero">
        <div className="leftSide">
          <h1>The Alternative School</h1>
          <p>
            Alternative schools provide personalized education for students who
            don't fit well in traditional settings. They include Montessori,
            Waldorf, charter, magnet, special education, virtual, and
            therapeutic schools. These schools offer innovative teaching and
            supportive environments but vary in quality and accessibility, which
